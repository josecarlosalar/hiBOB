...
**Estado actual:** Solo existe `PROJECT_ROADMAP.md`, nada más creado.
...
```
[ ] Prerrequisito: Instalar gcloud CLI + gcloud auth login
[ ] PASO 1: Verificar proyecto GCP websites-technology activo
[ ] PASO 2: Habilitar 5 APIs (aiplatform, run, firestore, firebase, iam)
[ ] PASO 3: Crear SA gemini-agent-sa + asignar 3 roles
[ ] PASO 4: Crear estructura de carpetas del monorepo
[ ] PASO 5: Descargar key JSON a backend/credentials/ + configurar ADC
[ ] PASO 6: Crear .gitignore y README.md en raíz
[ ] PASO 7: firebase init Firestore + registrar apps Android e iOS
[ ] PASO 8: nest new backend + instalar dependencias + .env.example
[ ] PASO 9: flutter create mobile + agregar dependencias + flutter analyze
[ ] PASO 10: DoD - backend en :3000 + Flutter compila sin errores
```
